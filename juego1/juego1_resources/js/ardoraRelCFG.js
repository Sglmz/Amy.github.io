...
var cR=["<p>número reales</p>","<p>valor absoluto</p>","<p>mas o menos</p>","<p>números enteros</p>","<p>vectores</p>","<p>sumatorio</p>","<p>números naturales</p>","<p>raiz cuadrada</p>"]; ansRL=["Mg==","NQ==","Mw==","Ng==","MA==","NA==","MQ==","Nw=="];
var iR=["","","","","","","",""];
var auR=[5,7,1,3,6,2,4,8];
